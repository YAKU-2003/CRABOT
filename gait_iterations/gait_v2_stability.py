"""
CrabBot Gait — Iteration 2 (Stability Tuning)
Changes from v1:
- Reduced yaw swing 35 -> 25 deg
- Slowed step time 300 -> 600ms
- Pitch lift increased 10 -> 20 deg
- Bot was less wobbly but still occasionally toppled when going backwards

Run: python3 gait_v2_stability.py
"""
